...
{
	protected static readonly MAX_ACTIVE_CHANNELS: number = 32;
	...
	/**
		...
		ActionScript). The value of `SoundMixer.bufferTime` cannotor
	...
	**/
	...
	protected static __soundChannels: Array<SoundChannel> = new Array();
	protected static __soundTransform: SoundTransform = new SoundTransform();
	...
	**/
	...
	protected static __registerSoundChannel(soundChannel: SoundChannel): void
	{
		SoundMixer.__soundChannels.push(soundChannel);
	}

	protected static __unregisterSoundChannel(soundChannel: SoundChannel): void
	{
		var index = SoundMixer.__soundChannels.indexOf(soundChannel);
		if (index > -1) SoundMixer.__soundChannels.splice(index, 1);
	}
	...
	**/
	...
	public static set soundTransform(value: SoundTransform)
	{
		...
		for (let channel of SoundMixer.__soundChannels)
		{
			(<internal.SoundChannel><any>channel).__updateTransform();
		}
	}
}
