...
**/
export default class NetStatusEvent extends Event
{
	/**
	...
	**/
	public static readonly NET_STATUS: EventType<NetStatusEvent> = "netStatus";
	...
	**/
	...
	protected static __pool: ObjectPool<NetStatusEvent> = new ObjectPool<NetStatusEvent>(() => new NetStatusEvent(null),
		(event) => event.__init());
	...
	**/
	public constructor(type: string, bubbles: boolean = false, cancelable: boolean = false, info: Object = null)
	{
