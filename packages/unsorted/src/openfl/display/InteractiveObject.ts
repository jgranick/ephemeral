...
{
	// /** @hidden */ @:dox(hide) public accessibilityImplementation:openfl.accessibility.AccessibilityImplementation;
	// /** @hidden */ @:dox(hide) public contextMenu:openfl.ui.ContextMenu;
	...
	**/
	public softKeyboardInputAreaOfInterest: Rectangle;

	protected __tabEnabled: null | boolean;
	protected __tabIndex: number;
