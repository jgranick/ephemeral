...
export default class Loader extends DisplayObjectContainer
{
	...
	protected __contentLoaderInfo: LoaderInfo;
	protected __library: AssetLibrary;
	protected __path: string;
	protected __uncaughtErrorEvents: UncaughtErrorEvents;
	protected __unloaded: boolean;
	...
	**/
	public load(request: URLRequest, context: LoaderContext = null): void
	{
		...
		(<internal.LoaderInfo><any>this.contentLoaderInfo).__loaderURL = Lib.current.loaderInfo.url;
		(<internal.LoaderInfo><any>this.contentLoaderInfo).__url = request.url;
		...
		if (request.contentType == null || request.contentType == "")
		{
			...
			(<internal.LoaderInfo><any>this.contentLoaderInfo).__contentType = contentType;
		}
		else
		{
			(<internal.LoaderInfo><any>this.contentLoaderInfo).__contentType = request.contentType;
		}
	...
	/**
		...
		@event unload        Dispatched by the `contentLoaderInfo`
							 object when a loaded object is removed.
	**/
	public loadBytes(buffer: ByteArray, context: LoaderContext = null): void
	{
	...
	**/
	public unload(): void
	{
		if (!this.__unloaded)
		{
			...
			this.__content = null;
			(<internal.LoaderInfo><any>this.contentLoaderInfo).__url = null;
			(<internal.LoaderInfo><any>this.contentLoaderInfo).__contentType = null;
			(<internal.LoaderInfo><any>this.contentLoaderInfo).__content = null;
			(<internal.LoaderInfo><any>this.contentLoaderInfo).__bytesLoaded = 0;
			(<internal.LoaderInfo><any>this.contentLoaderInfo).__bytesTotal = 0;
			(<internal.LoaderInfo><any>this.contentLoaderInfo).__width = 0;
			(<internal.LoaderInfo><any>this.contentLoaderInfo).__height = 0;
			this.__unloaded = true;
	...
	**/
	public unloadAndStop(gc: boolean = true): void
	{
		...
		{
			(<internal.DisplayObject><any>this.content).__stopAllMovieClips();
		}

		for (let i = 0; i < this.numChildren; i++)
		{
			(<internal.DisplayObject><any>this.getChildAt(i)).__stopAllMovieClips();
		}
	...
	protected __dispatchError(text: string): void
	{
	...
	protected __setContent(content: DisplayObject, width: number, height: number): void
	{
		this.__content = content;

		(<internal.LoaderInfo><any>this.contentLoaderInfo).__content = content;
		(<internal.LoaderInfo><any>this.contentLoaderInfo).__width = width;
		(<internal.LoaderInfo><any>this.contentLoaderInfo).__height = height;
	...
	protected BitmapData_onError(error: any): void
	{
	...
	protected BitmapData_onProgress(bytesLoaded: number, bytesTotal: number): void
	{
	...
	protected loader_onComplete(event: Event): void
	{
		...
		{
			(<internal.LoaderInfo><any>this.contentLoaderInfo).__bytes = loader.data;
			BitmapData.loadFromBytes(loader.data).onComplete(this.BitmapData_onLoad).onError(this.BitmapData_onError);
		}
	}

	protected loader_onError(event: IOErrorEvent): void
	{
		// TODO: Dispatch HTTPStatusEvent

		(<internal.Event><any>event).__target = this.contentLoaderInfo;
		this.contentLoaderInfo.dispatchEvent(event);
	}

	protected loader_onProgress(event: ProgressEvent): void
	{
		(<internal.Event><any>event).__target = this.contentLoaderInfo;
		this.contentLoaderInfo.dispatchEvent(event);
	}
