	...
	**/
	...
	/**
		...
		@param focalPointRatio     A number that controls the location of the
								   ...
								   respectively.
	**/
	public constructor(type: GradientType = null, colors: Array<number> = null, alphas: Array<number> = null, ratios: Array<number> = null, matrix: Matrix = null,
		spreadMethod: SpreadMethod = null, interpolationMethod: InterpolationMethod = null, focalPointRatio: number = 0)
	{
		if (type == null)
		{
		...
		this.__graphicsDataType = GraphicsDataType.GRADIENT;
		this.__graphicsFillType = GraphicsFillType.GRADIENT_FILL;
	}
}
