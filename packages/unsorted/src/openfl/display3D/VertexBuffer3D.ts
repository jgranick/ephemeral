...
/**
	...
	`dispose()` method.
**/
export default class VertexBuffer3D
{
	protected __bufferUsage: Context3DBufferUsage;
	protected __context: Context3D;
	protected __dataPerVertex: number;
	protected __numVertices: number;

	protected constructor(context3D: Context3D, numVertices: number, dataPerVertex: number, bufferUsage: Context3DBufferUsage)
	{
