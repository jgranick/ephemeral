...
export default class LoaderContext
{
	...
	**/
	// /** @hidden */ @:dox(hide) @:require(flash11) public imageDecodingPolicy:openfl.system.ImageDecodingPolicy;
	...
	/**
		...
		obtained by parsing the requesting URL. If the `parameters` is
		set, the `contentLoaderInfo.parameters` gets its value from the
		LoaderContext object, instead of from the requesting URL. The
		`parameters` accepts only objects containing name-value string
	...
	**/
	// /** @hidden */ @:dox(hide) @:require(flash11) public parameters:Dynamic;
	...
	**/
	// /** @hidden */ @:dox(hide) @:require(flash11) public requestedContentParent:DisplayObjectContainer;
