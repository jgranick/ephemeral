...
export default class Sound extends EventDispatcher
{
	...
	**/
	public constructor(stream: URLRequest = null, context: SoundLoaderContext = null)
	{
		super();
	...
	**/
	...
	{
		(<any>this.url) = stream.url;
		if (this.url != null)
		{
			// __backend.load(stream, context);
		}
		else
		{
	...
	**/
	...
	{
		if (paths == null) return <Future<Sound>>Future.withError("");
