	...
	/**
		...
		@param joints       A value from the JointStyle class that specifies the
							...
							**Note:** For `joints` set to
							...
							of the miter.
	**/
	public constructor(thickness: null | number = null, pixelHinting: boolean = false, scaleMode: LineScaleMode = LineScaleMode.NORMAL,
		caps: CapsStyle = CapsStyle.NONE, joints: JointStyle = JointStyle.ROUND, miterLimit: number = 3, fill: IGraphicsFill = null)
	{
		...
		this.__graphicsDataType = GraphicsDataType.STROKE;
	}
}
