...
export default class UncaughtErrorEvent extends ErrorEvent
{
	...
	**/
	public static readonly UNCAUGHT_ERROR: EventType<UncaughtErrorEvent> = "uncaughtError";

	protected static __pool: ObjectPool<UncaughtErrorEvent> = new ObjectPool<UncaughtErrorEvent>(() =>
		new UncaughtErrorEvent(null), (event) => event.__init());
	...
	**/
	public constructor(type: string, bubbles: boolean = true, cancelable: boolean = true, error: any = null)
	{
