...
{
	// /** @hidden */ @:dox(hide) @:require(flash10) public perspectiveProjection:PerspectiveProjection;

	protected __colorTransform: ColorTransform;
	protected __concatenatedColorTransform: ColorTransform;
	protected __displayObject: DisplayObject;
	protected __hasMatrix: boolean;
	protected __hasMatrix3D: boolean;
	protected __pixelBounds: Rectangle;
	...
	**/
	...
	protected __setTransform(a: number, b: number, c: number, d: number, tx: number, ty: number): void
	{
