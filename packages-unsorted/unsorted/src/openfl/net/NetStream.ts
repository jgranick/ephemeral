...
/**
	...
	**Note:** To send data through an audio file, like an mp3 file, use the
	...
	@event status           Dispatched when the application attempts to play
							...
							`"DRM.encryptedFLV"`.
**/
export default class NetStream extends EventDispatcher
{
	/**
	...
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10) public static CONNECT_TO_FMS:String;
	...
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10_1) public audioReliable:Bool;
	...
	/**
		...
		errors.
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10_1) public audioSampleAccess:Bool;
	...
	/**
		...
		property to FALSE.
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10_1) public backBufferLength (default, null):Float;
	...
	/**
		...
		TRUE.
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10_1) public backBufferTime:Float;
	...
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10_1) public bufferTimeMax:Float;
	...
	**/
	...
	/**
		...
		**To associate the `client` property with an event handler:**
		...
		```
		2. Assign a handler for the desired data event as a property
		of the client object:
		```haxe
		customClient.onImageData = onImageDataHandler;
		```
		3. Write the handler to receive the data event object, such
		as:
		```as3
		public onImageDataHandler(imageData:Object):void {
		...
		**To associate the `client` property with a subclass:**
		...
		1. Create a subclass with a handler to receive the data event
		object:
		```as3
		class CustomClient {
			public onMetaData(info:Object):void {
	...
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10_1) public inBufferSeek:Bool;
	...
	/**
		...
		state.
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10) public info (default, null):openfl.net.NetStreamInfo;
	...
	**/
	...
	/**
		...
		higher.
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10) public maxPauseBufferTime:Float;
	...
	/**
		...
		property.
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10_1) public multicastAvailabilitySendToAll:Bool;
	...
	/**
		...
		control overhead.
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10_1) public multicastAvailabilityUpdatePeriod:Float;
	...
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10_1) public multicastFetchPeriod:Float;
	...
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10_1) public multicastInfo (default, null):openfl.net.NetStreamMulticastInfo;

	/**
		For RTMFP connections, specifies the maximum number of peers to which
		to proactively push multicast media.
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10_1) public multicastPushNeighborLimit:Float;
	...
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10_1) public multicastRelayMarginDuration:Float;
	...
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10_1) public multicastWindowDuration:Float;
	...
	**/
	...
	/**
		...
		property is set to TRUE.
	**/
	// /** @hidden */ @:dox(hide) @:require(flash10_1) public videoReliable:Bool;
